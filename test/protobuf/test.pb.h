...
namespace fixbug {
class GetFriednListsRequest;
class GetFriednListsRequestDefaultTypeInternal;
extern GetFriednListsRequestDefaultTypeInternal _GetFriednListsRequest_default_instance_;
class GetFriednListsResponse;
class GetFriednListsResponseDefaultTypeInternal;
extern GetFriednListsResponseDefaultTypeInternal _GetFriednListsResponse_default_instance_;
class LoginRequest;
...
class LoginResponse_TestEntry_DoNotUse;
class LoginResponse_TestEntry_DoNotUseDefaultTypeInternal;
extern LoginResponse_TestEntry_DoNotUseDefaultTypeInternal _LoginResponse_TestEntry_DoNotUse_default_instance_;
class ResultCode;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::fixbug::GetFriednListsRequest* Arena::CreateMaybeMessage<::fixbug::GetFriednListsRequest>(Arena*);
template<> ::fixbug::GetFriednListsResponse* Arena::CreateMaybeMessage<::fixbug::GetFriednListsResponse>(Arena*);
...
template<> ::fixbug::LoginResponse_TestEntry_DoNotUse* Arena::CreateMaybeMessage<::fixbug::LoginResponse_TestEntry_DoNotUse>(Arena*);
...
class LoginResponse_TestEntry_DoNotUse : public ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<LoginResponse_TestEntry_DoNotUse, 
    ::PROTOBUF_NAMESPACE_ID::int32, std::string,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT32,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    0 > {
public:
  typedef ::PROTOBUF_NAMESPACE_ID::internal::MapEntry<LoginResponse_TestEntry_DoNotUse, 
    ::PROTOBUF_NAMESPACE_ID::int32, std::string,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_INT32,
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::TYPE_STRING,
    0 > SuperType;
  LoginResponse_TestEntry_DoNotUse();
  LoginResponse_TestEntry_DoNotUse(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  void MergeFrom(const LoginResponse_TestEntry_DoNotUse& other);
  static const LoginResponse_TestEntry_DoNotUse* internal_default_instance() { return reinterpret_cast<const LoginResponse_TestEntry_DoNotUse*>(&_LoginResponse_TestEntry_DoNotUse_default_instance_); }
  static bool ValidateKey(void*) { return true; }
  static bool ValidateValue(std::string* s) {
    return ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(s->data(), static_cast<int>(s->size()), ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::PARSE, "fixbug.LoginResponse.TestEntry.value");
 }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_test_2eproto);
    return ::descriptor_table_test_2eproto.file_level_metadata[2];
  }
...
class GetFriednListsRequest :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriednListsRequest) */ {
 public:
  GetFriednListsRequest();
  virtual ~GetFriednListsRequest();

  GetFriednListsRequest(const GetFriednListsRequest& from);
  GetFriednListsRequest(GetFriednListsRequest&& from) noexcept
    : GetFriednListsRequest() {
    *this = ::std::move(from);
  }

  inline GetFriednListsRequest& operator=(const GetFriednListsRequest& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriednListsRequest& operator=(GetFriednListsRequest&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriednListsRequest& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriednListsRequest* internal_default_instance() {
    return reinterpret_cast<const GetFriednListsRequest*>(
               &_GetFriednListsRequest_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(GetFriednListsRequest& a, GetFriednListsRequest& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriednListsRequest* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriednListsRequest* New() const final {
    return CreateMaybeMessage<GetFriednListsRequest>(nullptr);
  }

  GetFriednListsRequest* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriednListsRequest>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriednListsRequest& from);
  void MergeFrom(const GetFriednListsRequest& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriednListsRequest* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriednListsRequest";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriednListsRequest)
 private:
  class _Internal;
...
class GetFriednListsResponse :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.GetFriednListsResponse) */ {
 public:
  GetFriednListsResponse();
  virtual ~GetFriednListsResponse();

  GetFriednListsResponse(const GetFriednListsResponse& from);
  GetFriednListsResponse(GetFriednListsResponse&& from) noexcept
    : GetFriednListsResponse() {
    *this = ::std::move(from);
  }

  inline GetFriednListsResponse& operator=(const GetFriednListsResponse& from) {
    CopyFrom(from);
    return *this;
  }
  inline GetFriednListsResponse& operator=(GetFriednListsResponse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const GetFriednListsResponse& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const GetFriednListsResponse* internal_default_instance() {
    return reinterpret_cast<const GetFriednListsResponse*>(
               &_GetFriednListsResponse_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(GetFriednListsResponse& a, GetFriednListsResponse& b) {
    a.Swap(&b);
  }
  inline void Swap(GetFriednListsResponse* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline GetFriednListsResponse* New() const final {
    return CreateMaybeMessage<GetFriednListsResponse>(nullptr);
  }

  GetFriednListsResponse* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<GetFriednListsResponse>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const GetFriednListsResponse& from);
  void MergeFrom(const GetFriednListsResponse& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(GetFriednListsResponse* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.GetFriednListsResponse";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:fixbug.GetFriednListsResponse)
 private:
  class _Internal;
...
// map<int32, string> test = 3;
inline int LoginResponse::_internal_test_size() const {
  return test_.size();
}
inline int LoginResponse::test_size() const {
  return _internal_test_size();
}
inline void LoginResponse::clear_test() {
  test_.Clear();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, std::string >&
LoginResponse::_internal_test() const {
  return test_.GetMap();
}
inline const ::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, std::string >&
LoginResponse::test() const {
  // @@protoc_insertion_point(field_map:fixbug.LoginResponse.test)
  return _internal_test();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, std::string >*
LoginResponse::_internal_mutable_test() {
  return test_.MutableMap();
}
inline ::PROTOBUF_NAMESPACE_ID::Map< ::PROTOBUF_NAMESPACE_ID::int32, std::string >*
LoginResponse::mutable_test() {
  // @@protoc_insertion_point(field_mutable_map:fixbug.LoginResponse.test)
...
// uint32 userid = 1;
inline void GetFriednListsRequest::clear_userid() {
  userid_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriednListsRequest::_internal_userid() const {
  return userid_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetFriednListsRequest::userid() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriednListsRequest.userid)
  return _internal_userid();
}
inline void GetFriednListsRequest::_internal_set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  userid_ = value;
}
inline void GetFriednListsRequest::set_userid(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_userid(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriednListsRequest.userid)
}
...
// .fixbug.ResultCode result = 1;
inline bool GetFriednListsResponse::_internal_has_result() const {
  return this != internal_default_instance() && result_ != nullptr;
}
inline bool GetFriednListsResponse::has_result() const {
  return _internal_has_result();
}
inline void GetFriednListsResponse::clear_result() {
  if (GetArenaNoVirtual() == nullptr && result_ != nullptr) {
    delete result_;
  }
  result_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriednListsResponse::_internal_result() const {
  const ::fixbug::ResultCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriednListsResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriednListsResponse.result)
  return _internal_result();
}
inline ::fixbug::ResultCode* GetFriednListsResponse::release_result() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriednListsResponse.result)
  
  ::fixbug::ResultCode* temp = result_;
  result_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriednListsResponse::_internal_mutable_result() {
...
inline ::fixbug::ResultCode* GetFriednListsResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriednListsResponse.result)
  return _internal_mutable_result();
}
inline void GetFriednListsResponse::set_allocated_result(::fixbug::ResultCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
  ...
  result_ = result;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriednListsResponse.result)
}

// repeated .fixbug.User friend_list = 2;
inline int GetFriednListsResponse::_internal_friend_list_size() const {
  return friend_list_.size();
}
inline int GetFriednListsResponse::friend_list_size() const {
  return _internal_friend_list_size();
}
inline void GetFriednListsResponse::clear_friend_list() {
  friend_list_.Clear();
}
inline ::fixbug::User* GetFriednListsResponse::mutable_friend_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriednListsResponse.friend_list)
  return friend_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriednListsResponse::mutable_friend_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriednListsResponse.friend_list)
  return &friend_list_;
}
inline const ::fixbug::User& GetFriednListsResponse::_internal_friend_list(int index) const {
  return friend_list_.Get(index);
}
inline const ::fixbug::User& GetFriednListsResponse::friend_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriednListsResponse.friend_list)
  return _internal_friend_list(index);
}
inline ::fixbug::User* GetFriednListsResponse::_internal_add_friend_list() {
  return friend_list_.Add();
}
inline ::fixbug::User* GetFriednListsResponse::add_friend_list() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriednListsResponse.friend_list)
  return _internal_add_friend_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriednListsResponse::friend_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriednListsResponse.friend_list)
  return friend_list_;
}
