...
class UserService : public wyx::UserServiceRpc //使用在rpc服务发布端(rpc服务提供者)
{
public:
    ...
    */
    void Login(::google::protobuf::RpcController *controller,
               const ::wyx::LoginRequest *request,
               ...
               ::google::protobuf::Closure *done)
    {
        ...
        *4一个回调，把LoginResponse发送给rpc client
        */
        ...
        //把响应写入
        wyx::ResultCode *code = response->mutable_result();
        code->set_errcode(0);
        code->set_errmsg("");
    ...
    void Register(::google::protobuf::RpcController *controller,
                  const ::wyx::RegisterRequest *request,
                  ::wyx::RegisterResponse *response,
                  ::google::protobuf::Closure *done)
    {
...
{   
    //调用框架的初始化操作 provider -i config.com
